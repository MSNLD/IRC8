...
public class Admin : Command, ICommand
{
    ...
    public new void Execute(IChatFrame chatFrame)
    {
        ...
        */
        ...
        var adminInfo1 = chatFrame.Server.GetDataStore().Get(IrcStrings.ConfigAdminInfo1);
        var adminInfo2 = chatFrame.Server.GetDataStore().Get(IrcStrings.ConfigAdminInfo2);
        var adminInfo3 = chatFrame.Server.GetDataStore().Get(IrcStrings.ConfigAdminInfo3);
