...
internal class Pics : PropRule
{
    ...
    public Pics() : base(IrcStrings.ChannelPropPICS, EnumChannelAccessLevel.ChatMember,
        EnumChannelAccessLevel.None, IrcStrings.ChannelPropPICSRegex, string.Empty, true)
    {
    }
}