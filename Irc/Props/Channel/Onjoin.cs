...
internal class Onjoin : PropRule
{
    ...
    public Onjoin() : base(IrcStrings.ChannelPropOnJoin, EnumChannelAccessLevel.ChatHost,
        EnumChannelAccessLevel.ChatHost, IrcStrings.ChannelPropOnjoinRegex, string.Empty)
    {
    }
}