...
namespace Irc.Objects.User
{
    public class User : ChatObject, IUser
    {
            ...
            IServer server) : base(modes, dataStore)
        {
            ...
            base.Props.Add(Resources.IrcStrings.UserPropOid, "");
            base.Props.Add(Resources.IrcStrings.UserPropSubscriberInfo, "");
            base.Props.Add(Resources.IrcStrings.UserPropMsnProfile, "");
            base.Props.Add(Resources.IrcStrings.UserPropRole, "");
        }
