    ...
    public void Execute()
    {
        ...
        switch (result)
        {
            ...
            case EnumIrcError.ERR_NOCHANOP:
            {
                ...
                Source.Send(Raws.IRCX_ERR_CHANOPRIVSNEEDED_482(Source.Server, Source, (Objects.Channel)Target));
                break;
            }
            ...
            {
                Source.Send(Raws.IRCX_ERR_NOTONCHANNEL_442(Source.Server, Source, (Objects.Channel)Target));
                break;
            }
            ...
            {
                Source.Send(Raws.IRCX_ERR_KEYSET_467(Source.Server, Source, (Objects.Channel)Target));
                break;
            }
        }
    }
